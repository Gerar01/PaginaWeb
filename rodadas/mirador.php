...
<html lang="en">
  ...
  <center><h2><b>Rodada al Mirador</b></h2></center>
      <br><br class="d-lg-none d-block"><br class="d-lg-none d-block">
    <div class="row justify-content-center align-items-center">
      <div class="col-lg-4 col-10 order-lg-1 order-2">
        <?php

            $respuesta1 = file_get_contents("https://maps.googleapis.com/maps/api/directions/json?key=AIzaSyD7BBiSsezwo97XAFbdRPK_I6STi3x00Gg&origin=16.2469659,-92.1200795&destination=16.2586452,-92.1491981&mode=bicycling");
            $json = json_decode($respuesta1);
    ...
    src="https://www.google.com/maps/embed/v1/directions?key=AIzaSyD7BBiSsezwo97XAFbdRPK_I6STi3x00Gg&origin=16.2469659,-92.1200795&destination=16.2586452,-92.1491981&mode=bicycling" allowfullscreen></iframe>
</div>
    </div>
    </div>
    <br>
